...
🎮 Play Now
Play on GitHub Pages (Coming Soon)
...
Got an Idea? Great! Just half an idea? Perfect! Just create an issue with:
...
Ready to dive deep? Check out our Contributor Guide for:
...
Adding New Games
Extend the BaseGame class in js/games/
Follow existing patterns in connections.js
Add your game data to data/puzzles.json
